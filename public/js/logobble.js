 ...
 */
function loadCard(cardData, isNewCard, isUploadedCard, isGeneratedCard) {
    isEditingCard = false;
    editingCardId = null;
...
function uploadCards(inputFile) {
...
function clearTemplate(cardKeys) {
...
function updatePrevCard(element) {
...
function syncPreview(itemToSync) {
...
function updateCard(card, editCardBtn, saveCardBtn) {
    isEditingCard = false;
    editingCardId = null;
...
function handleGroupHtml(groupingId) {
...
function generateCards(groupingId, groupId, cardsNumber) {
    freezePage(true);
...
function changeFont(fontSelector) {
...
function changeCardType(syllablesTemplate, imagesTemplate) {
